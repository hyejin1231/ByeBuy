...
//                    holder.tv_alaram.setText(snapshot.child(uniqueTest).child("status").getValue().toString());
...
//                        Toast.makeText(context, "성공", Toast.LENGTH_SHORT).show();
                    ...
                    }else if(snapshot.child(uniqueTest).child("status").getValue().toString().equals("reservation")){
                        holder.tv_alaram.setText("예약중");
                    }
